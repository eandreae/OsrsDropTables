...
public class DukeDrops{

     public static void main(String []args){
         // Roll 1/90
            // If not, 1/48 awakener orb
            // if not, 1/25 tablet
            // if not, 1/200 ice quartz
            // if not, 1/5 for food
            // if not normal loots
        // for 1/90:
            // 1/8 virtus
        ...
        for (int i = 1; i <= num_rolls; i++){
            ...
            // Step 3: Roll the 1/25 for tablet
                ...
                OutputReward = ("Frozen Tablet awarded at kill " + i);
                TabletOwned = true;
                System.out.println(OutputReward);
            }
            ...
            // Step 4: Roll the 1/200 for Ice Quartz
                ...
                OutputReward = ("Ice Quartz awarded at kill " + i);
                System.out.println(OutputReward);
            }
            else {
