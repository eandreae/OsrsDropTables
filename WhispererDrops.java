...
public class WhispererDrops{
     ...
     public static void main(String []args){
        ...
        int num_rolls = 1000;
        int unique_chance = 64;
        int awakener_orb_chance = 34;
        ...
        UniqueTable.put(8, "Siren's Staff");
        ...
        for (int i = 1; i <= num_rolls; i++){
            ...
            // Step 3: Roll the 1/25 for tablet
                ...
                OutputReward = ("Sirenic Tablet awarded at kill " + i);
                TabletOwned = true;
                System.out.println(OutputReward);
            }
            ...
            // Step 4: Roll the 1/200 for Ice Quartz
                ...
                OutputReward = ("Shadow Quartz awarded at kill " + i);
                System.out.println(OutputReward);
            }
            else {
